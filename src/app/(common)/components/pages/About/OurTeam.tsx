...
export default function OurTeamSection() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-transparent py-16 md:py-20 lg:py-24">
          ...
          <div className="mx-auto mb-16 grid max-w-5xl grid-cols-1 gap-6 md:mb-20 md:grid-cols-3 md:gap-8">
            {leaders.map((leader, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-black md:text-xl">{leader.name}</h3>
                <p className="text-sm text-purple-800">{leader.role}</p>
                <p className="mt-2 text-xs text-black/52">{leader.experience} experience</p>
              </div>
            ))}
          </div>
              ...
              {regularTeam.map((member, index) => (
                ...
                >
                  ...
                  <div className="p-4 text-center">
                    ...
                    <p className="mb-2 text-xs text-black/58 md:text-sm">{member.role}</p>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex flex-wrap justify-center gap-8 md:gap-12">
              <div className="text-center">
                <p className="text-2xl font-bold text-purple-800 md:text-3xl">{teamMembers.length}+</p>
                <p className="text-xs text-black/55">Expert Members</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-purple-800 md:text-3xl">500+</p>
                <p className="text-xs text-black/55">Projects Delivered</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-purple-800 md:text-3xl">8+</p>
