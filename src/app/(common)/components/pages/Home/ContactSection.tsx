...
export default function ContactSection() {
  return (
    <section id="contact" className="bg-[#0b0b0b] px-4 py-16 text-white sm:px-6 sm:py-20 lg:px-8 lg:py-24">
            ...
            <div className="mt-8 flex flex-col gap-5 sm:mt-10 sm:flex-row sm:flex-wrap sm:items-center lg:gap-6">
              {people.map((person, index) => (
                <div key={person.name} className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full border border-[#52F447]/25 bg-[linear-gradient(135deg,rgba(82,244,71,0.22),rgba(255,255,255,0.05))] text-sm font-semibold text-white shadow-[0_0_24px_rgba(82,244,71,0.12)]">
                    {person.initials}
                  </div>
                  <div>
          ...
          <div className="rounded-[26px] border border-white/10 bg-[#171717] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.28)] sm:rounded-[30px] sm:p-6 lg:p-7">
            <form className="space-y-4 sm:space-y-5">
              <input
                ...
                className="h-[54px] w-full rounded-[14px] border border-white/10 bg-[#1c1c1c] px-4 text-[15px] text-white outline-none transition placeholder:text-white/38 focus:border-[#52F447]/55"
              />
              <input
                type="email"
                placeholder="Email*"
              ...
              <textarea
                ...
                rows={6}
                className="w-full rounded-[14px] border border-white/10 bg-[#1c1c1c] px-4 py-4 text-[15px] text-white outline-none transition placeholder:text-white/38 focus:border-[#52F447]/55"
              />

              <button
                type="submit"
                className="inline-flex h-[56px] w-full items-center justify-center gap-3 rounded-full border border-[#52F447] bg-[linear-gradient(180deg,rgba(82,244,71,0.14),rgba(82,244,71,0.05))] text-[17px] font-semibold text-white transition hover:bg-[#52F447] hover:text-black"
              >
                Submit Inquiry
