...
type SocialMediaAdsCampaignExpectationItem = {
  title: string;
  content: string;
};

type SocialMediaAdsCampaignExpectationsSectionProps = {
  title: string;
  items: SocialMediaAdsCampaignExpectationItem[];
  imageSrc: string;
  imageAlt?: string;
};

export default function SocialMediaAdsCampaignExpectationsSection({
  title,
  items,
  imageSrc,
  imageAlt = "social-media-ads-campaign",
}: SocialMediaAdsCampaignExpectationsSectionProps) {
