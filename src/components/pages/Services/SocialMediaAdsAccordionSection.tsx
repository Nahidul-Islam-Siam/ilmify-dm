...
export type SocialMediaAdsAccordionItemData = {
  title: string;
  content: string;
};

type SocialMediaAdsAccordionSectionProps = {
  eyebrow: string;
  title: string;
  items: SocialMediaAdsAccordionItemData[];
  accent: string;
};

export default function SocialMediaAdsAccordionSection({
  eyebrow,
  title,
  items,
  accent,
}: SocialMediaAdsAccordionSectionProps) {
