...
export type SocialMediaAdsShowcaseItem = {
  id: string;
  title: string;
  description: string;
  imageSrc: string;
...
type SocialMediaAdsServicesShowcaseProps = {
  id?: string;
  title: string;
  items: SocialMediaAdsShowcaseItem[];
  accent?: string;
};

export default function SocialMediaAdsServicesShowcase({
  id,
  title,
  items,
  accent = "#9c8cff",
}: SocialMediaAdsServicesShowcaseProps) {
  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        .social-media-ads-scroll-row {
          -ms-overflow-style: none;
          scrollbar-width: none;
        }
        .social-media-ads-scroll-row::-webkit-scrollbar {
          display: none;
        }
      `}</style>
    </section>
